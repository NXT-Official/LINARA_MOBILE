...
3. Integrate the swipable SOP visual slide deck inside the card (refer to [`src/components/ui/carousel.tsx`](src/components/ui/carousel.tsx)). Slides display step instructions and safety focus alerts (e.g., _"Make sure temperature is safe"_).
